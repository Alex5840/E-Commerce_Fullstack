  ...
  return (
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800'>
        <div className='container mx-auto px-4 py-3'>
            ...
            {isAdmin &&(<Link className='bg-emerald-700 hover:text-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ese-in-out flex items-center' to={"/secret-dashboard"}><Lock className='inline-block mr-1 size ={18}'></Lock>
